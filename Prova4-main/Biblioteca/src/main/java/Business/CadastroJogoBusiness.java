...
public class CadastroJogoBusiness {

    private Connection connection;

    public CadastroJogoBusiness()
    {
    ...
    {
        String sql = "CREATE TABLE IF NOT EXISTS `bancodedados`.`jogos` (\n" +
    ...
    public String cadastrarJogo() {
        ...
        System.out.println("Insira o ID da Categoria ao qual o jogo pertence");
